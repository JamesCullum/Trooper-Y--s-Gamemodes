# [Trooper[Y]](http://forum.sa-mp.de/index.php?page=User&userID=2520)'s Gamemodes
...
- **CallOfWar.pwn** // Unfertig // Beinhaltet eine Grundausbildung inklusive [Fahrprüfung](https://www.youtube.com/watch?v=9WHtJ8F7EoQ) und [Flugprüfung](https://www.youtube.com/watch?v=7ropm_a_9mU), sollte in Richtung Singleplayer CoD werden. [Die erste Mission](https://www.youtube.com/watch?v=ySd-qR6E3pg) ist dabei, die Map wurde entfernt da sie von [InternetInk](http://forum.sa-mp.de/index.php?page=User&userID=1146) erstellt wurde, wendet euch an ihn um sie zu bekommen.
...
- **Savandreas Strategy** // Aufbauspiel // [Trailer](https://www.youtube.com/watch?v=ULRYwt0_zHc) // Man baut Gebäude, baut Ressourcen ab, es gibt einen Commander und jede Einheit eines normalen Strategiespieles wird durch einen Spieler gesteuert. Extrem innovativ, offensichtlich *zu* innovativ. Erfordert viele Spieler bevor es richtig Spaß macht.
